...
public class LangUtil {
        ...
        public enum InternalMessage {
                ...
                public String toString() {
                        return definitions.getOrDefault(DiscordSRV.config().getLanguage(),
                                        definitions.get(Language.EN));
                }
        ...
        public enum Message {
                ...
                WEBHOOK_DELIVER_JAVA_MARK("WebhookDeliverJavaEditionMark", false),
                WEBHOOK_DELIVER_BEDROCK_MARK("WebhookDeliverBedrockEditionMark", false),
                ...
                INVALID_CODE("InvalidCode", false), LINKED_SUCCESS("LinkedCommandSuccess", true),
                ...
                UNABLE_TO_LINK_ACCOUNTS_RIGHT_NOW("LinkingError", true), UNKNOWN_CODE("UnknownCode", false),
